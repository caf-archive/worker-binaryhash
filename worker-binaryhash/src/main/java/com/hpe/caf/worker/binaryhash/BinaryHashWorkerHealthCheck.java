...
/**
 * Health check for the BinaryHashWorker, health is displayed on the Marathon GUI.
 */
public class BinaryHashWorkerHealthCheck implements HealthReporter
{
    public BinaryHashWorkerHealthCheck()
    {
    }
    ...
    public HealthResult healthCheck()
    {
        ...
        // In this scenario, the BinaryHashWorker does not depend on any external components. It will always return HealthResult.RESULT_HEALTHY.
